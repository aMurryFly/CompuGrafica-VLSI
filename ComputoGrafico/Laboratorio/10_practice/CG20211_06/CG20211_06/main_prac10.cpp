...
float	incX = 0.0f,
		...
		rotInc = 0.0f,
		giroMonitoInc = 0.0f,
		movBrazoDerInc = 0.0f, //calculo del incremento
		movBrazoIzqInc = 0.0f,
		rotRodDerInc = 0.0f,
		cabezaInc = 0.0f;
...
int FrameIndex = 0;			//INTRODUCIT PARA PRE-CARGAR DE FRAMES
bool play = false;
int playIndex = 0;
...
void saveFrame(void)
{
	...
	KeyFrame[FrameIndex].cabezaM = cabezaM;
...
void interpolation(void)
{
	...
	movBrazoIzqInc = (KeyFrame[playIndex + 1].movBrazoDer - KeyFrame[playIndex].movBrazoIzq) / i_max_steps;
	rotRodDerInc = (KeyFrame[playIndex + 1].rotRodIzq - KeyFrame[playIndex].rotRodIzq) / i_max_steps;
	cabezaInc = (KeyFrame[playIndex + 1].cabezaM - KeyFrame[playIndex].cabezaM) / i_max_steps;
...
int main()
{
	...
	/*
	//PARA PREGUARDAR LAS POSICIONES
	KeyFrame[0].posX = 0;
	KeyFrame[0].posY = 0;
	KeyFrame[0].posZ = 0;
	...
	*/
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate(model, glm::radians(movBrazoDer), glm::vec3(1.0f, 0.0f, 0.0f)); //mover el brazo derecho 
		staticShader.setMat4("model", model);
		...
		//Cabeza
		model = glm::translate(tmp, glm::vec3(0.0f, -1.0f, 0.0f));
		model = glm::rotate(model, glm::radians(cabezaM), glm::vec3(1.0f, 0.0f, 0.0f));
