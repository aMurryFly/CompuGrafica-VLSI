...
void LoadTextures()
{
	...
	t_cubo_dado = generateTextures("Texturas/Cube03.png", 1);
}
...
void display(Shader shader)
{
	...
	glBindTexture(GL_TEXTURE_2D, t_cubo_dado);
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Practica 8 - AMV", NULL, NULL);
	if (window == NULL)
	{
